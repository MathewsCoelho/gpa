...
CREATE TABLE IF NOT EXISTS `projeto` (
  ...
  `status_projeto` enum('Iniciado','Finalizado','Atrasado') DEFAULT NULL,
  `id_usuario` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`id_projeto`),
  UNIQUE KEY `nome_projeto` (`nome_projeto`),
...
ALTER TABLE `grupo`
  ...
  ADD CONSTRAINT `grupo_ibfk_2` FOREIGN KEY (`id_projeto`) REFERENCES `projeto` (`id_projeto`);
